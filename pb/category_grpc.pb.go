...
const (
	...
	CategoryService_ListCategorys_FullMethodName  = "/pb.CategoryService/ListCategorys"
)
...
type CategoryServiceClient interface {
	...
	ListCategorys(ctx context.Context, in *ListCategorysRequest, opts ...grpc.CallOption) (*ListCategorysResponse, error)
}
...
func (c *categoryServiceClient) ListCategorys(ctx context.Context, in *ListCategorysRequest, opts ...grpc.CallOption) (*ListCategorysResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListCategorysResponse)
	err := c.cc.Invoke(ctx, CategoryService_ListCategorys_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCategoryServiceServer) ListCategorys(context.Context, *ListCategorysRequest) (*ListCategorysResponse, error) {
...
func _CategoryService_ListCategorys_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).ListCategorys(ctx, req.(*ListCategorysRequest))
	}
	return interceptor(ctx, in, info, handler)
}
