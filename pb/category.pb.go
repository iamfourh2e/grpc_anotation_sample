...
const file_category_proto_rawDesc = "" +
	"\n" +
	"\x0ecategory.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\"\\\n" +
	"\bCategory\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x18\n" +
	"\aparents\x18\x03 \x03(\tR\aparents\x12\x12\n" +
	...
	"\x04data\x18\x01 \x03(\v2\f.pb.CategoryR\x04data2\x87\x04\n" +
	"\x0fCategoryService\x12b\n" +
	"\x0eCreateCategory\x12\x19.pb.CreateCategoryRequest\x1a\x1a.pb.CreateCategoryResponse\"\x19\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/categories\x12[\n" +
	"\vGetCategory\x12\x16.pb.GetCategoryRequest\x1a\x17.pb.GetCategoryResponse\"\x1b\x82\xd3\xe4\x93\x02\x15\x12\x13/v1/categories/{id}\x12l\n" +
	"\x0eUpdateCategory\x12\x19.pb.UpdateCategoryRequest\x1a\x1a.pb.UpdateCategoryResponse\"#\x82\xd3\xe4\x93\x02\x1d:\x01*\x1a\x18/v1/categories/{data.id}\x12d\n" +
	"\x0eDeleteCategory\x12\x19.pb.DeleteCategoryRequest\x1a\x1a.pb.DeleteCategoryResponse\"\x1b\x82\xd3\xe4\x93\x02\x15*\x13/v1/categories/{id}\x12_\n" +
	"\x0eListCategories\x12\x19.pb.ListCategoriesRequest\x1a\x1a.pb.ListCategoriesResponse\"\x16\x82\xd3\xe4\x93\x02\x10\x12\x0e/v1/categoriesB\x1aZ\x18grpc_anotation_sample/pbb\x06proto3"
...
var file_category_proto_goTypes = []any{
	...
	(*ListCategoriesResponse)(nil), // 10: pb.ListCategoriesResponse
}
var file_category_proto_depIdxs = []int32{
	...
	0,  // 5: pb.ListCategoriesResponse.data:type_name -> pb.Category
	...
	9,  // 10: pb.CategoryService.ListCategories:input_type -> pb.ListCategoriesRequest
	...
	10, // 15: pb.CategoryService.ListCategories:output_type -> pb.ListCategoriesResponse
